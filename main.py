"""
CustomerAI Main Orchestrator - Coordinates all system components
"""
...
class CustomerAI:
    """Main orchestrator for CustomerAI system."""
    
    def __init__(self, config_path: str = "config.yaml"):
        """Initialize the CustomerAI system.
    ...
    def initialize_components(self) -> None:
        ...
        # Initialize database
        self.db = DatabaseManager(self.config.get('memory', {}).get('database', 'customerai.db'))
