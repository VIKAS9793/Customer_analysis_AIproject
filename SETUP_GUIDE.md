...
# Verify installation
python -c "import customer_analysis_ai" && echo "Installation successful"
```
...
python -c "from customer_analysis_ai.db import verify_connection; verify_connection()"
```
...
# Start monitoring
python -m customer_analysis_ai.monitoring.start
```
